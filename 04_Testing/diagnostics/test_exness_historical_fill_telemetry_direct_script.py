...
The historical telemetry diagnostic must be runnable as:

    python 04_Testing/diagnostics/exness_historical_fill_telemetry_diagnostic.py --help
...
def test_direct_script_help_bootstraps_project_root(repo_root: Path) -> None:
    ...
    script = (
        ...
        "diagnostics"
        /
        "exness_historical_fill_telemetry_diagnostic.py"
    )
