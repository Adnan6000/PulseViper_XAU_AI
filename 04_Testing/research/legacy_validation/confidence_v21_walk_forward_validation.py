...
Default:
python 04_Testing/research/legacy_validation/confidence_v21_walk_forward_validation.py --bars 160000 --cutoff-date 2026-06-29 --discovery-days 10 --embargo-days 1 --oos-days 5 --step-days 5 --max-folds 8
...
research: Any = importlib.import_module(
    "04_Testing.research.legacy_validation.confidence_v21_research_validation"
)
